...
import { ScheduledClassPatternList, ScheduledClassPatternCreate, ScheduledClassPatternEdit } from '../features/scheduledclasspatterns';
...
export default function App() {
  ...
  <Admin basename="/admin" dataProvider={dataProvider} authProvider={authProvider} i18nProvider={raI18nProvider} layout={Layout} dashboard={Dashboard}>
      ...
      <Resource name="scheduledclasspatterns" list={ScheduledClassPatternList} create={ScheduledClassPatternCreate} edit={ScheduledClassPatternEdit} />
    </Admin>
  );
}
