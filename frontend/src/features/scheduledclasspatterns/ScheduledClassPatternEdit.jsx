...
import { Edit, SimpleForm, TextInput, ReferenceInput, SelectInput, ReferenceArrayInput, SelectArrayInput, DateInput, NumberInput, ArrayInput, SimpleFormIterator, useTranslate } from 'react-admin';
