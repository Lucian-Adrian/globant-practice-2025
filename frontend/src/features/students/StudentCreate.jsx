...
export default function makeStudentCreate() {
  return function StudentCreate(props) {
    ...
    return (
      <Create {...props} redirect="list" transform={transformCreate} title={translate('ra.page.create', { defaultValue: 'Create' })}>
        <SimpleForm redirect="list">
          ...
          <TextInput source="confirm_password" label={translate('resources.students.fields.confirm_password', { defaultValue: 'Confirm password' })} type="password" validate={[validateConfirmPassword]} />
