...
import { Edit, SimpleForm, TextInput, ReferenceInput, SelectInput, DateTimeInput, NumberInput, useTranslate, required } from 'react-admin';
import { validateScheduledClass } from '../../shared/validation/lessonValidation';
import { CheckSingleTimeAvailabilityButton, CourseStudentsInput } from '../../shared/components/forms';
  ...
  return (
    <Edit {...props}>
      <SimpleForm validate={async (values) => validateScheduledClass(values, t, values?.id)}>
        ...
        <CheckSingleTimeAvailabilityButton />
